...
const DESC =
  "Compare Western Red Cedar shingles to composite and synthetic siding. Natural beauty, durability, eco-friendliness, and cost — which is right for your project?";
  ...
  jsonLd: [
    {
      ...
      itemListElement: [
        ...
        { "@type": "ListItem", position: 2, name: "Cedar vs Composite", item: `${SITE_URL}/cedar-vs-composite` },
      ],
    },
  ],
});

export default function VsComposite() {
  return (
    <SiteLayout>
