...
const DESC =
  "Learn why Western Red Cedar (Thuja plicata) is North America's premier shingle wood — natural rot resistance, straight grain, and decades of proven durability for siding and DIY projects.";
  ...
  jsonLd: [
    {
      ...
      itemListElement: [
        ...
        { "@type": "ListItem", position: 2, name: "Cedar Species", item: `${SITE_URL}/western-red-cedar` },
      ],
    },
  ],
});
...
function Section({ title, alt, children }: { title: string; alt?: boolean; children: ReactNode }) {
  return (
