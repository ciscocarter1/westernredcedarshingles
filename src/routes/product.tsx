      ...
      <section className="mx-auto max-w-4xl px-4 py-20 sm:px-6">
        ...
        <div className="font-body prose-cedar mt-6 space-y-5 text-lg text-foreground/85">
          ...
          <p>
            ...
            and grain produces a rustic warmth that pristine Number One Blue Label simply can't replicate. For sheds, gazebos, pergolas, and siding applications, our #3/#4 grade undercourse Western Red Cedar
        ...
        <div className="mt-8 overflow-hidden rounded-lg border border-border">
          <table className="w-full text-left">
            ...
            <tbody className="font-body text-foreground/85">
              {[
                ["50 sq ft", "4 bundles"], ["100 sq ft", "8 bundles"], ["200 sq ft", "15 bundles"], ["500 sq ft", "37 bundles"],
              ].map(([s, b]) => (
