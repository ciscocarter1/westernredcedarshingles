  ...
  return (
    <SiteLayout>
      ...
      <section className="relative isolate overflow-hidden bg-forest py-20 text-forest-foreground">
        <img src={textureImg} alt="Close-up of Western Red Cedar wood grain texture showing natural color variation" width={1600} height={900} className="absolute inset-0 -z-10 h-full w-full object-cover opacity-10" />
