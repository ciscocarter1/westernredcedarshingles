...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Define Your Home With Character and Charm Using Lowes Cost Effective Western Red Cedar Shingles" },
      { property: "og:description", content: "Define Your Home With Character and Charm Using Lowes Cost Effective Western Red Cedar Shingles" },
      { name: "twitter:description", content: "Define Your Home With Character and Charm Using Lowes Cost Effective Western Red Cedar Shingles" },
    ...
    scripts: [
      {
        async: true,
        src: "https://www.googletagmanager.com/gtag/js?id=G-T5BXYZVMG5",
      },
      {
